...
public interface EstoqueWS {
     ...
     * @param filtros
     * @return
     *     returns com.andersonmarques.estoquews.cliente.ListaItens
     */
    ...
    @RequestWrapper(localName = "TodosOsItens", targetNamespace = "http://ws.estoque.caelum.com.br/", className = "com.andersonmarques.estoquews.cliente.TodosOsItens")
    @ResponseWrapper(localName = "TodosOsItensResponse", targetNamespace = "http://ws.estoque.caelum.com.br/", className = "com.andersonmarques.estoquews.cliente.TodosOsItensResponse")
     ...
     * @param parameters
     * @return
     *     returns com.andersonmarques.estoquews.cliente.CadastrarItemResponse
